export const PlaySVG = (props) => {
  return (
    <svg
      width={props.buttonIconStyle.width}
      height={props.buttonIconStyle.height}
      viewBox='0 0 184 184'
      fill='none'
    ...
    >
      <circle
        ...
        cy='92'
        r='90.5'
        stroke={props.buttonIconStyle.color}
        strokeWidth={props.buttonIconStyle.strokeWidth}
      />
      <path
  ...
  return (
    ...
    >
      <path
        ...
        stroke={props.buttonIconStyle.color}
        strokeWidth={props.buttonIconStyle.strokeWidth}
        fill={props.buttonIconStyle.color}
      />
      <circle
        cx='92'
        cy='92'
